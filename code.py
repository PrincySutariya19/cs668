...
"""**Conclusion:**
*XGBoost outperformed Linear Regression with a lower RMSE and higher R² value, making it a better fit for predicting the freight_cost_(usd) target variable.*
